...
import 'package:skiwm/race_wengen.dart';
import 'package:skiwm/resources/globals.dart';
import 'package:skiwm/utils/constants.dart';
import 'components/dialog_pause.dart';

class RaceWengenPage extends StatefulWidget {
  const RaceWengenPage({Key? key}) : super(key: key);

  @override
  RaceWengenState createState() => RaceWengenState();
}

class RaceWengenState extends State<RaceWengenPage> {
  RaceWengenGame game = RaceWengenGame();
